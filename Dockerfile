...
RUN npm i
# Argument de la commande de lancement pour lancer le profil de dev avec Vite (hot reload)
CMD ["dev"]
...
ENV LOG_LEVEL=error
# Argument de la commande de lancement pour lancer le profil de prod sans Vite
CMD ["build"]
